...
- Replace the **_email-password_** folder in the localtion **_Kratos/contrib/quickstart/kratos/email-password_**
  with folder **_Kratos_config_App/email-password_** provided in the vachan-api repo

- replace the **_quickstart.yml_** of Ory Kratos with **\*quickstart.yml** in **\_Kratos_config_App**
...
```
VACHAN_KRATOS_APP_ADMIN_URL = http://127.0.0.1:4444/
VACHAN_KRATOS_APP_PUBLIC_URL = http://127.0.0.1:4443/
