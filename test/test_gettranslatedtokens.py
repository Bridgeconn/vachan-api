...
def test_gettranslatedtokensup(supply_url,get_supAdmin_accessToken):
...
def test_gettranslatedtokenad(supply_url,get_adm_accessToken):
	url = supply_url + '/v1/info/translatedtokens'
...
def test_gettranslatedtokentr(supply_url,get_trans_accessToken):
	url = supply_url + '/v1/info/translatedtokens'
