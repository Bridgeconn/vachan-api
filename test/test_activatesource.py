...
@pytest.mark.parametrize('sourceId',[('35')])
...
@pytest.mark.parametrize('sourceId',[('35')])
def test_activatesource_4(supply_url,get_supAdmin_accessToken,sourceId):
	url = supply_url + '/v1/autographamt/source/activate'
	data = {
			'sourceId':sourceId
			}
...
@pytest.mark.parametrize('sourceId',[('12')])
def test_activatesource_6(supply_url,get_adm_accessToken,sourceId):
	url = supply_url + '/v1/autographamt/source/activate'
	data = {
			'sourceId':sourceId
			}
