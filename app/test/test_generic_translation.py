...
def test_tokenize():
    ...
    default_response = client.put(UNIT_URL+'/tokens?resource_language=en', headers=headers_auth,
    ...
    #without auth
    response = client.put(UNIT_URL+'/tokens?resource_language=en&include_phrases=True',
    ...
    response = client.put(UNIT_URL+'/tokens?resource_language=en',
...
def test_tokenize_with_diff_flags():
    ...
    response = client.put(UNIT_URL+"/tokens?resource_language=hi"+
    ...
    response = client.put(UNIT_URL+"/token-translate?resource_language=hi"+
...
def test_token_translate():
    ...
    #tokenize
    resp = client.put(UNIT_URL+"/tokens?resource_language=hi&use_translation_memory=false"+
