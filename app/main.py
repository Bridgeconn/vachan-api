...
app = FastAPI(title="Vachan-API", version="2.0.0-beta.24",
...
beta_endpoints = [
    ...
    "/v2/bibles/{resource_name}/versification",
    "/v2/bibles/{resource_name}/books/{book_code}/format/{output_format}",
...
def custom_openapi():
    ...
    openapi_schema = get_openapi(title="Vachan-API", version="2.0.0-beta.24",
        description="The server application that provides APIs to interact \
        with the underlying Databases and modules in Vachan-Engine.",
        routes=app.routes)
